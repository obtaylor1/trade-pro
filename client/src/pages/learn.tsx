            ...
            {q.options.map((opt,oi)=>{
              ...
              return(
                <button key={oi} onClick={()=>!submitted&&setAnswers(a=>({...a,[qi]:oi}))}
                  ...
                  style={{background:correct?"rgba(34,197,94,0.15)":wrong?"rgba(239,68,68,0.15)":selected?"rgba(59,130,246,0.15)":"#0d1117",border:`1px solid ${correct?"#22c55e":wrong?"#ef4444":selected?"#3b82f6":"#243044"}`,color:correct?"#4ade80":wrong?"#f87171":selected?"#60a5fa":"#94a3b8"}}>
                  {opt}
                </button>
              );
            })}
